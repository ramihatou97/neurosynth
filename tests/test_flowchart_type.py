...
class TestFlowchartEnum:
    ...
    def test_flowchart_enum_exists(self):
        ...
        assert (
            ImageType.FLOWCHART.value == "flowchart"
    ...
    def test_flowchart_in_priority_order(self):
        ...
        assert (
            ImageType.FLOWCHART in priority_order
    ...
    def test_flowchart_not_high_priority(self):
        ...
        assert (
            not ImageType.FLOWCHART.is_high_priority
...
class TestFlowchartPatterns:
    ...
    def test_flowchart_patterns_defined(self):
        ...
        assert (
            ImageType.FLOWCHART in extractor.TYPE_PATTERNS
    ...
    def test_flowchart_key_patterns_present(self):
        ...
        assert not missing, f"Missing essential FLOWCHART patterns: {missing}"
...
class TestFlowchartIntegration:
    ...
    def test_flowchart_in_output_type_priority(self):
        ...
        assert (
            ImageType.FLOWCHART in type_priority
        ), "FLOWCHART should be in type_priority dict"
        assert (
            type_priority[ImageType.FLOWCHART] == 30
    ...
    def test_flowchart_visual_element_creation(self):
        ...
        try:
            ...
            pytest.fail(
                f"AttributeError when creating VisualElement with FLOWCHART: {e}"
            )
    ...
    def test_flowchart_in_section_sorting(self):
        ...
        visuals = [
            ...
            VisualElement(
                id="s1", image_type=ImageType.SURGICAL_STEP, type_confidence=0.8
            ),
            VisualElement(
                id="a1", image_type=ImageType.ANATOMICAL, type_confidence=0.85
            ),
