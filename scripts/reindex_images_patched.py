...
def reindex_images(dry_run: bool = False, force_all: bool = False):
    ...
    try:
        ...
        # PATCHED: Force connection to Qdrant Service
        logger.info("Connecting to Qdrant Service at neurosynth-qdrant:6333...")
        q_client = QdrantClient(host="neurosynth-qdrant", port=6333)
