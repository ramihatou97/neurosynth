...
class JobConfig(BaseModel):
    ...
    output_format: str = Field(default="latex", description="Output format (latex, markdown)")
...
class JobProgress(BaseModel):
    ...
    percent: Optional[float] = Field(None, description="Progress percentage (0-100)")
...
class JobResponse(BaseModel):
    ...
    progress: Optional[JobProgress] = Field(None, description="Current progress")
    ...
    output_path: Optional[str] = Field(None, description="Path to output file if completed")
