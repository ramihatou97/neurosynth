...
class ExtractedImage:
    ...
    # Caption
    caption: Optional[DetectedCaption] = None
...
class UnifiedExtractionPipeline:
    ...
    def extract_from_pdf(
        ...
        try:
            ...
            extracted_images = self._extract_and_filter_images(
                doc, pages, images_dir
            )
            ...
            latex_code = self._generate_latex(
                extracted_images, result.sequences
            )
            ...
            for img_tuple in image_list:
                ...
                try:
                    ...
                    extracted_img = ExtractedImage(
                        ...
                        category=ImageCategory(filter_result.image_type) 
                            if filter_result.image_type in [e.value for e in ImageCategory]
        ...
        for page_num in pages:
            ...
            for i, img_block in enumerate(image_blocks):
                ...
                for assoc in associations:
                    page_images[i].associated_text.append(
                        assoc.text_block.text[:200]
                    )
                    page_images[i].keywords.update(
                        assoc.score.keywords_matched
                    )
    ...
    def _extract_vectors(
        ...
        for page_num in pages:
            ...
            vectors = self.vector_extractor.extract_from_page(
    ...
    def _generate_latex(
        ...
        for seq in sequences:
            ...
            for elem in seq.elements:
                ...
                img = next(
                    (i for i in images if i.image_id == elem.image_id),
                    None
                )
...
def extract_images_from_pdf(
    pdf_path: str,
    output_dir: str = None,
    config: NeuroSynthEnhancedConfig = None
) -> ExtractionResult:
    """
