...
class ImageExtractor:
    ...
    TYPE_KEYWORDS = {
        ImageType.ANATOMY_DIAGRAM: [
            'anatomy', 'anatomic', 'nerve', 'artery', 'vein', 'muscle',
            'bone', 'structure', 'relationship', 'course', 'origin', 'insertion'
        ],
        ImageType.SURGICAL_PHOTO: [
            'intraoperative', 'operative', 'surgical field', 'exposure',
            'dissection', 'retraction', 'microsurgical', 'view of'
        ],
        ImageType.IMAGING_MRI: [
            'mri', 'magnetic resonance', 't1', 't2', 'flair', 'weighted'
        ],
        ImageType.IMAGING_CT: [
            'ct', 'computed tomography', 'scan', 'axial', 'coronal', 'sagittal'
        ],
        ImageType.IMAGING_ANGIO: [
            'angiogram', 'angiography', 'arteriogram', 'dsa', 'catheter'
        ],
        ImageType.DIAGRAM: [
            'diagram', 'schematic', 'algorithm', 'flowchart', 'decision'
        ],
        ImageType.HISTOLOGY: [
            'histology', 'pathology', 'h&e', 'stain', 'microscopy', 'specimen'
        ],
    }
