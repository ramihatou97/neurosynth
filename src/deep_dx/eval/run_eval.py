...
Grade (0-10) and brief justification."""
            ...
            with open(output_path, "w") as f:
                json.dump({"metadata": data.get("metadata"), "results": results}, f, indent=2)
    ...
    if avg_score < 7.0:
        print("💡 Suggestion: Low score detected. Consider increasing top_k or improving ingestion chunk_size.")
