...
AI_ENABLED = bool(ANTHROPIC_API_KEY) and os.environ.get(
    "NEUROSYNTH_DISABLE_AI", ""
...
EMBEDDING_MODEL = _EMBEDDING_MODELS.get(
    EMBEDDING_MODEL_TYPE, _EMBEDDING_MODELS["medical"]
)
...
USE_RICH_RESULTS_TREE = os.environ.get("NEUROSYNTH_RICH_TREE", "true").lower() in (
    "1",
    "true",
    "yes",
)
