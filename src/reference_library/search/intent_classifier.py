...
from .query_intent_lean import (
    IntentDetector as LeanIntentDetector,
    IntentResult as LeanIntentResult,
    QueryIntent,
    get_intent_detector
)
...
def get_hybrid_classifier(database=None, api_key: Optional[str] = None) -> HybridIntentClassifier:
