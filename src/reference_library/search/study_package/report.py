    ...
    def to_ui_summary(self, detail_level: str = "standard") -> str:
        ...
        if detail_level == "minimal":
            ...
            if self.has_error:
                ...
                lines.append(f"📚 Study Mode: {self.topics_found_count} of {len(self.ai_suggested_topics)} foundational topics ({rate_pct}%)")
            ...
            if self.missing_topics and len(self.missing_topics) <= 3:
                ...
                lines.append(f"   Missing: {len(self.missing_topics)} topics not in library")
