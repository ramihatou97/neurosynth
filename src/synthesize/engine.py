...
from index.search import RetrievalResult, SearchEngine
from models import (
    ANATOMY_TEMPLATE,
...
class SynthesisEngine:
    ...
    def __init__(self, db: Database, search_engine: SearchEngine, ai_client: AIClient):
        self.db = db
        self.search = search_engine
        self.ai = ai_client

    def synthesize_chapter(
        self, topic: str, template_name: str = "surgical_procedure"
    ) -> SynthesizedChapter:
        """
    ...
    def _select_images_for_section(
        ...
        for img in all_images:
            ...
            # Combined score
            total_score = (
                (type_score * 0.3) + (caption_score * 0.3) + (context_score * 0.4)
            )
