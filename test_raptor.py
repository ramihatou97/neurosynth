...
def main():
    ...
    mock_chunks = [
        {
            "text": "Glioblastoma multiforme (GBM) is the most common primary malignant brain tumor. Standard treatment involves surgery, radiation, and temozolomide.",
            "metadata": {"source": "doc1"},
        },
        {
            "text": "The Stupp protocol for GBM consists of radiotherapy with concomitant temozolomide followed by adjuvant temozolomide.",
            "metadata": {"source": "doc1"},
        },
        {
            "text": "Meningiomas are typically benign tumors arising from the arachnoid cap cells. they are often cured by surgical resection.",
            "metadata": {"source": "doc2"},
        },
        {
            "text": "Simpson Grade I resection of meningioma involves complete removal of tumor and dural attachment. This offers best recurrence-free survival.",
            "metadata": {"source": "doc2"},
        },
        {
            "text": "Deep vein thrombosis (DVT) is a significant risk in neurosurgical patients. Prophylaxis includes mechanical compression and chemical anticoagulation.",
            "metadata": {"source": "doc3"},
        },
        {
            "text": "Unfractionated heparin or low-molecular-weight heparin are used for chemical DVT prophylaxis. Timing depends on hemorrhage risk.",
            "metadata": {"source": "doc3"},
        },
        {
            "text": "Pineal region tumors include germinomas, pineocytomas, and pineoblastomas. Parinaud's syndrome is a common presentation.",
            "metadata": {"source": "doc4"},
        },
        {
            "text": "Surgical approaches to the pineal region include the supracerebellar infratentorial approach and the occipital transtentorial approach.",
            "metadata": {"source": "doc4"},
        },
    ]
