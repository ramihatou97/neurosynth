...
print(f"Total Figures in Summary: {data.get('figure_summary', {}).get('total_figures')}")
...
for source in data.get("sources", []):
    ...
    for fig in figures:
        ...
        caption = fig.get("caption", "No caption")[:50] + "..." if len(fig.get("caption", "")) > 50 else fig.get("caption", "")
